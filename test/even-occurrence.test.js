...
const evenOccurrence = require("../src/even-occurrence.js");
...
describe("evenOccurrence", function() {
  ...
  it("should return null if given [ 'cat', 'dog', 'dig', 'cat' ]", function() {
    assert.equal(evenOccurrence([ 'cat', 'dog', 'dig', 'cat' ]), "cat");
  })
  it("should return 'cat' if given [ 'one', 'two', 'three' ]", function() {
